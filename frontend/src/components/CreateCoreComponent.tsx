...
const CreateCoreComponent = ({ back }: { back: () => void }) => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        formData.append("value", coreName);
        formData.append("file", file);

        try {
            setIsLoading(true);
            await CreateCore(formData,dispatch);
            setCoreName("");
            setFile(null);
            setPreview(null);
        } catch (error) {
        ...
        <div className='w-full h-full flex flex-col !p-2'>
            ...
            >
              <div className="flex-1">
                ...
                <div className='flex-1'>
                    <label htmlFor="file" className='text-gray-600 font-semibold'>Texture</label>
                    <input
                        id='file'
                        name='file'
                        type="file"
...
export default CreateCoreComponent;
